...
layout: interview
slug: garrett.miller
title: Garrett Miller - Loudgif
summary: Mashing Up Gifs and Sounds. Pew Pew Pew.
categories: [gifs, mashups, maps, east coast media illuminati]
---

#### Who are you and what do you do for a living?

I was an art major at Oberlin College and I paid for a lot of it by doing a lot of web design stuff. So, I did that for a long time, and then I worked in government for a bit and moved over to doing web development for a company called [O Power][opower]. I joined when it was really small and then it grew huge and I left because it was too many people. Now I'm doing [Mapbox][mapbox], which is mapping software.
...
Yeah, exactly. Charlie's an interesting story. He decided to, on his free time, follow NASA's landsat feed and process the imagery on his own. I think you might have seen that little [Twitter story](http://stories.twitter.com/en/get_a_job.html) on him getting hired.

#### Yeah, I remember seeing his Flickr album and seeing the quality of his mapping images and I think [it got written up in Wired][wired].
...
#### The project we're going to talk about today is [loudgif][loudgif]. Could you give a quick description of what loudgif is?
